...
/**
 * MJI NativePeer class for java.lang.StrictMath library abstraction
 */
...
//    System.err.println("Warning: StrictMath.abs not modeled yet");
//    return (a <= .0) ? -a : a;
//  }
...
//    // to inline it
//	System.err.println("Warning: StrictMath.max not modeled yet");
...
//	System.err.println("Warning: StrictMath.min not modeled yet");
...
//	  System.err.println("Warning: StrictMath.ceil not modeled yet");
//	  return StrictMath.ceil(a);
//  }
//
////TODO: fix
//  public static double floor__D__D (MJIEnv env, int clsObjRef, double a) {
//	  System.err.println("Warning: StrictMath.floor not modeled yet");
...
//	  System.err.println("Warning: StrictMath.rint not modeled yet");
